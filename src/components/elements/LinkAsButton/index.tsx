...
const typeStyles: Record<string, string> = {
  ...
  'secondary-full': 'w-full grid place-items-center text-white font-semibold text-sm 2xl:text-lg rounded-b-md md:rounded-b-lg bg-orange-50 px-6 py-2.5 2xl:px-8 2xl:py-3.5',
};

...
const CardPrice = ({ item, timePlanType }: CardPriceProps) => {
  ...
  return (
    <div className='rounded-xl border border-white-95 bg-white-99 px-5 py-8 md:px-6 md:py-10 2xl:px-8 2xl:py-12'>
      <div
        className='grid place-items-center rounded border border-orange-90 bg-orange-97 p-2 text-base font-medium md:p-2.5 md:text-lg 2xl:rounded-md 2xl:p-3 2xl:text-2xl'>
        {planType}
      </div>
      ...
      <Button onPress={handleOpenModal}
        className='w-full grid place-items-center text-white font-semibold text-sm 2xl:text-lg rounded-b-md md:rounded-b-lg rounded-t-none  bg-orange-50 px-6 py-2.5 2xl:px-8 2xl:py-3.5'>
        Get Started
      </Button>
